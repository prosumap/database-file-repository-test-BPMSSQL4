...
CREATE VIEW [dbo].[vwDailyUpdSlct_Projection]
AS
SELECT f21_vdrs_sku_listing.[offer_id], 
       ...
       f21_vdrs_sku_listing.[sh_revenue]         AS [NET DEMAND], 
...
GROUP  BY f21_vdrs_sku_listing.[offer_id], 
          ...
          [mktbl_skumaster].[sku], 
          f21_vdrs_sku_listing.[version_no], 
          f21_vdrs_sku_listing.[sh_revenue], 
          mktbl_skumaster.[unit_price], 
          mktbl_skumaster.[cost_ea] 
HAVING (( ( f21_vdrs_sku_listing.[version_no] ) = -2 )); 
GO
